(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Handee.js"] = factory();
	else
		root["Handee.js"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PressAndHold = function (_React$Component) {
	  _inherits(PressAndHold, _React$Component);

	  function PressAndHold(props) {
	    _classCallCheck(this, PressAndHold);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PressAndHold).call(this, props));
	  ...
	  _createClass(PressAndHold, [{
	    ...
	    value: function handleMouseDown(e, child) {
	      ...
	      setTimeout(function () {
	        _this2.runTimer(new Date().getTime(), new Date().getTime(), target);
	      }, 0);
	    }
	  }, {
	    key: 'handleMouseUp',
	    ...
	    key: 'runTimer',
	    value: function runTimer(start, current, target) {
	      var _this3 = this;

	      // if we're not in a hold state, return
	      if (!this.state.hold) return;

	      if (current - start >= this.props.duration) {
	        ...
	        requestAnimationFrame(function () {
	          return _this3.runTimer(start, new Date().getTime(), target);
	        });
	      }
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      var currentHoldLength = this.state.currentHoldLength;

	      var perCentComplete = Math.min(currentHoldLength / duration, 1);
	      var child = typeof children === 'function' ? children(perCentComplete) : children;
	      ...
	      return _react2.default.cloneElement(_react2.default.Children.only(child), {
	        onMouseDown: function onMouseDown(e) {
	          return _this4.handleMouseDown(e, child);
	        },
